<x-layout>
    <form action="{{route('ninjas.store')}}" method="POST">
        @csrf <!-- Security for all forms , when posting it tells the server that the request comes from our site and not external-->
        ...
        <textarea id="bio" name="bio" rows="5">{{ old('bio')}}"</textarea>
